...
overall_choices = [chr(ord('A')+i) for i in range(26)]
...
def evaluate(
    ...
    output_dir = os.path.join(output_dir,model_name,'commons')
    ...
    for subject in pbar:
        task_choice_num = task_choice_nums[subject]
        choices = overall_choices[:task_choice_num]
