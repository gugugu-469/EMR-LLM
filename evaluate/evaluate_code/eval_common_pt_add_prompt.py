...
class EvalTemplate:
    ...
    def parse_example(
        ...
        if 'answer' in example.keys():
            ...
            resp = ''
        return "".join([example["question"]] + candidates + [self.answer]), resp
...
eval_templates = {
    "en": EvalTemplate(
        system="The following are multiple choice questions about {subject}.\n\n",
        choice="\n{choice}. {content}",
        answer="\nFrom A to D, the answer is: ",
        prefix=" "
    ),
    "zh": EvalTemplate(
